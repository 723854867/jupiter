...
public class XmlSerializer implements Serializer {
	...
	public byte[] serial(Object model) {
		return beanToXml(model).getBytes(JupiterConsts.UTF_8);
	}

	@Override
	public <ENTITY> ENTITY deserial(byte[] data, Class<ENTITY> clazz) {
		return xmlTobean(new String(data, JupiterConsts.UTF_8), clazz);
	}
	...
	public static final String beanToXml(Object bean) {
		try {
			...
			marshaller.setProperty(Marshaller.JAXB_ENCODING, JupiterConsts.UTF_8);
