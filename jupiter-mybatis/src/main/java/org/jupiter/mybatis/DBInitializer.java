...
import org.jupiter.mybatis.extension.AutoEnumTypeHandler;
...
public class DBInitializer {
	...
	public DBConfig dbConfig() {
		return ConfigLoader.load("classpath*:conf/jdbc.properties").toBean(DBConfig.class, ColumnStyle.camel2dot);
	}
	...
	public DataSource datasource(DBConfig dbConfig) throws Exception {
	...
	public SqlSessionFactoryBean sessionFactory(DataSource dataSource, DBConfig dbConfig) throws Exception {
